...
function App() {
  ...
  useEffect(() => {
    ...
    const initialEdges = [
      ...
      { from: 1, to: 8, time: 6 },
      { from: 1, to: 9, time: 9 },
      { from: 1, to: 10, time: 13 },
      { from: 1, to: 11, time: 15 },
      { from: 1, to: 12, time: 14 },
      { from: 2, to: 3, time: 2 },
      { from: 2, to: 4, time: 3 },
      { from: 2, to: 5, time: 4 },
      { from: 2, to: 6, time: 5 },
      ...
      { from: 2, to: 8, time: 7 },
      { from: 2, to: 9, time: 10 },
      { from: 2, to: 10, time: 13 },
      { from: 2, to: 11, time: 15 },
      { from: 2, to: 12, time: 15 },
      { from: 3, to: 4, time: 1 },
      { from: 3, to: 5, time: 1 },
      { from: 3, to: 6, time: 3 },
      { from: 3, to: 7, time: 5 },
      { from: 3, to: 8, time: 7 },
      { from: 3, to: 9, time: 12 },
      { from: 3, to: 10, time: 13 },
      { from: 3, to: 11, time: 15 },
      { from: 3, to: 12, time: 15 },
      { from: 4, to: 5, time: 1 },
      { from: 4, to: 6, time: 2 },
      { from: 4, to: 7, time: 3 },
      { from: 4, to: 8, time: 5 },
      ...
      { from: 5, to: 12, time: 12 },
      { from: 6, to: 7, time: 5 },
      { from: 6, to: 8, time: 7 },
      { from: 6, to: 9, time: 14 },
      { from: 6, to: 10, time: 15 },
      { from: 6, to: 11, time: 16 },
      { from: 6, to: 12, time: 16 },
      { from: 7, to: 8, time: 2 },
      { from: 7, to: 9, time: 6 },
      { from: 7, to: 10, time: 7 },
      { from: 7, to: 11, time: 9 },
      ...
      { from: 10, to: 12, time: 2 },
      { from: 11, to: 12, time: 4 },
   ];
